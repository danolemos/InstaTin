...
public class Entrada {
    ...
    public void cadPessoa(Sistema s) {
        ...
        while (buscarUsuario(login) != null)
    ...
    public void login(Sistema s){
        ...
        while (opcao != 0){
            if (opcao == 1){
                ...
                this.seguir(escolhido);

            }

            else-if (opcao == 2){cadPostagem(s, this);}
    ...
    public void cadPostagem(Sistema s, Entrada u){
        ...
        System.out.println("*************Postagem.java cadastrada com sucesso*************");
    }
}
